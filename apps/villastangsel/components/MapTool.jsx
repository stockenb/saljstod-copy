...
async function reverseGeocode(lat, lng) {
  ...
  const [mesh, setMesh] = useState("50");
...
const mapOptions = useMemo(() => ({
  ...
  const lineItems = useMemo(() => {
    ...
    return rows;
  }, [skus, height, color, mesh, results, includeConcrete, concreteQty, includeGate, gates]);
...
}, [lineItems, height, color, mesh, results, getUnitPrice, runs, gates, includeConcrete, includeGate, address]);
...
const path = [
  ...
  >
    Maska
    <HelpTip
      text="Maska = storleken på hålen i nätet (mm). Mindre maska ger tätare nät. Vanligast på villastängsel är 50 mm. Vanligast på skolor/förskolor är 40 mm."
      /* placement="bottom"  // valfritt: "top" eller "bottom" */
    />
  </label>

  <select className="select" value={mesh} onChange={(e) => setMesh(e.target.value)}>
    ...
    <option value="40">40 mm</option>
          ...
          <div className="card card-pad">
            ...
            <div className="row" style={{ alignItems: "center", gap: 12 }}>
              ...
              />
              <label htmlFor="acc-concrete">Plintbetong (2/stolpe)</label>
            </div>
