...
export default function ToolHelp({ open, onClose }) {
  ...
  <div className="th-body th-pro">
    ...
    <section className="th-section">
      ...
      <ul className="th-list th-list--bullets">
        <li><strong>Höjd:</strong> välj önskad höjd på ditt stängsel (mm).</li>
        <li><strong>Färg:</strong> Välj bland våra färger.</li>
        <li><strong>Maska:</strong> 40 mm eller 50 mm.</li>
      </ul>
    </section>
    ...
    <section className="th-section">
      ...
      <ul className="th-list th-list--bullets">
        <li><strong>Plintbetong:</strong> bocka i för att räkna med plintbetong i din offert (2 per stolpe).</li>
    ...
    <section className="th-section">
      ...
      <ul className="th-list th-list--bullets">
        <li>Under <em>Beräkning</em> ser du total längd, antal stolpar (änd, hörn, mellan), antal stag, rullar stängsel (25 m), och stagtråd. Allt uppdateras i realtid när du ritar.</li>
      </ul>
    </section>
