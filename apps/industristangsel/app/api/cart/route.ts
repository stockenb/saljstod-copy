...
export const runtime = "nodejs"; // säkerställ Node-runtime så env funkar
...
export async function POST(req: Request) {
  try {
    ...
    // Förväntat: { checkoutUrl: "https://www.nilsahlgren.se/e/checkout/<id>/" }
...
// (valfritt) Om du vill att GET inte ska ge 405 i browsern:
